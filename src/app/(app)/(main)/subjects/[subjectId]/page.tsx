      ...
      <div className="max-w-6xl mx-auto space-y-4 pb-12 pt-1">
          ...
          <div className="relative z-10 grid md:grid-cols-3 gap-4 items-center">
            <div className="md:col-span-2 space-y-2">
              <div className="flex items-center gap-3">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 bg-white/10 rounded-full text-[10px] font-semibold uppercase tracking-wider">
              ...
              <div className="pt-2 flex flex-col gap-1 max-w-md">
                ...
                <Progress value={progressPercent} className="h-1.5 bg-black/20 [&>div]:bg-white" />
              </div>
            </div>
            
            <div className="flex flex-col items-start md:items-end gap-3 justify-center">
              <Button size="sm" className="bg-white text-indigo-900 hover:bg-indigo-50 font-bold rounded-lg shadow-sm transition-all h-9 px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <div key={i} className="bg-white border border-slate-100 px-4 py-3 rounded-xl shadow-[0_1px_2px_rgba(0,0,0,0.02)] flex items-center gap-3">
        ...
        <div className="pt-2">
          ...
          {!chapters || chapters.length === 0 ? (
            <div className="flex flex-col items-center justify-center p-10 text-center border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50/50">
              <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mb-4 shadow-sm border border-slate-100">
                <div className="w-16 h-16 bg-indigo-50 rounded-full flex items-center justify-center">
                  <Zap className="w-8 h-8 text-indigo-500" />
                </div>
              </div>
              <h3 className="text-lg font-bold text-slate-900 mb-1">This subject has no topics</h3>
              <p className="text-sm text-slate-500 max-w-sm mb-6">
                Start building out your curriculum by generating a structured syllabus using AI based on TNPSC standards.
              </p>
              <AdminOnly fallback={<p className="text-sm text-slate-500 italic">Please wait for an admin to publish content.</p>}>
            ...
            <div className="grid lg:grid-cols-2 gap-4">
              {chapters.map((chapter, index) => {
                ...
                return (
                  <div key={chapter.id} className="group bg-white border border-slate-200 p-3 rounded-xl shadow-sm hover:shadow-md hover:border-indigo-200 transition-all duration-300 flex flex-col">
                    <div className="flex justify-between items-start mb-2">
                      <div className="flex-1 pr-3">
                        <div className="flex items-center gap-2 mb-1.5">
                          <span className="text-[10px] font-bold text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded text-center uppercase tracking-wide">
                            Topic {index + 1}
                          </span>
                          <span className="text-[10px] font-bold text-amber-600 bg-amber-50 border border-amber-100 px-1.5 py-0.5 rounded text-center uppercase tracking-wide">
                            Medium
                          </span>
                        </div>
                        <h3 className="text-base font-bold text-slate-900 line-clamp-1 leading-tight">{chapter.title}</h3>
                    ...
                    <div className="flex items-center gap-4 text-xs text-slate-500 font-medium mb-3 pt-2 border-t border-slate-100">
