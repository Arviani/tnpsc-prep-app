      ...
      <div className="max-w-5xl mx-auto space-y-8 pb-12 min-h-[500px]">
        {isAdmin ? (
          <div className="flex flex-col items-center justify-center h-full text-center border-2 border-dashed border-border rounded-xl bg-secondary/50 p-8">
            ...
            <h3 className="text-xl font-bold text-foreground">No revision notes available.</h3>
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      ...
      <div className="bg-gradient-to-r from-amber-500 to-orange-500 p-8 rounded-3xl text-white shadow-md relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-card opacity-10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-4">
          <h3 className="font-bold text-foreground text-lg mb-4">Generation Tools</h3>
          ...
          <div className="grid grid-cols-1 gap-3">
            <AIActionButton 
              ...
              className="w-full h-14 text-sm justify-start rounded-xl px-5 border-border hover:border-amber-300 hover:bg-amber-50"
            />
            <AIActionButton 
              label="Bullet Notes" 
              icon={List}
        ...
        <div className="lg:col-span-8">
          <div className="bg-card rounded-2xl border border-border shadow-sm h-full min-h-[500px] flex flex-col overflow-hidden">
            <div className="bg-secondary border-b border-border-subtle px-6 py-4 flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center">
                <FileText className="w-4 h-4 text-amber-600" />
              </div>
              <h3 className="font-bold text-foreground">Generated Material</h3>
            </div>
            
            <div className="p-6 flex-1 flex flex-col bg-secondary/30">
              {isLoading && (
              ...
              {!isLoading && !isError && answer && (
                <div className="animate-in fade-in zoom-in-95 duration-300 h-full">
                  <AIResponseCard content={answer} className="bg-card border border-border shadow-sm min-h-[400px] text-base p-8" />
                </div>
              )}
              {!isLoading && !isError && !answer && (
                <div className="flex-1 flex flex-col items-center justify-center text-center max-w-sm mx-auto opacity-70">
                  ...
                  <h4 className="text-lg font-bold text-foreground mb-2">Ready to Revise?</h4>
