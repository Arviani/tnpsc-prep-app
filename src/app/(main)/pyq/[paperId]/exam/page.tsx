...
import { PYQExamEngine } from '@/components/practice/PYQExamEngine'

export default async function PYQExamPage({ params }: { params: Promise<{ paperId: string }> }) {
  ...
  // 3. Fetch Full Questions with Options
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-muted/20 w-full">
      <PYQExamEngine 
        ...
        durationMinutes={paper.duration_minutes || (paper.total_questions * 1.5)}
