  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-bold tracking-tight text-foreground">Available Chapters</h2>
      ...
      {!chapters || chapters.length === 0 ? (
        ...
        <div className="flex flex-col gap-4 mt-2">
          {chapters.map((chapter, index) => {
            ...
            return (
              <div key={chapter.id} className="p-5 border border-border rounded-xl bg-card transition-shadow hover:shadow-[0_4px_10px_rgba(13,21,48,0.05)] shadow-[0_1px_3px_rgba(0,0,0,0.10)]">
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-1">
                      ...
                      <h3 className="font-bold text-foreground text-lg">{chapter.title}</h3>
                    </div>
                    {chapter.description && (
                  ...
                  <div className="flex flex-col items-end justify-center min-w-[140px] gap-3">
                    <div className="w-full text-right">
                      <span className="text-xs font-semibold text-muted-foreground mb-1 block">{chapterProgress}% Completed</span>
